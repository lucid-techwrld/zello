...
import image from "../assets/images/06838e88dc8d4c-luxury-5-bedroom-fully-detached-duplex-detached-duplexes-for-sale-lekki-lagos.jpeg";
    ...
    <div className="min-h-screen flex items-center justify-between bg-gray-50">
      <div className="w-1/2 h-full hidden md:block lg:block ">
        ...
        {/* <div className="w-full h-full bg-black/50">
          <p>Start Listing Property Now!</p>
          <p>Zeello Homes & Properties</p>
        </div> */}
      </div>
      <div className="md:w-1/2 lg:w-1/2 w-full h-full flex justify-center items-center">
